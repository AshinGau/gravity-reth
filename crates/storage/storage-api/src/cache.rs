...
impl PersistBlockCache {
    ...
    pub fn bytecode_by_hash(&self, code_hash: &B256) -> Option<Bytecode> {
        ...
        self.cache.get(&CacheKey::StateContract(*code_hash)).and_then(|v| match v {
            ...
            _ => panic!("wrong bytecode_by_hash"),
        })
    }
